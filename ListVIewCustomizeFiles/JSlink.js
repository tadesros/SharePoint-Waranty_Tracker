...
(function () {
  document.write(
    '<link rel="stylesheet" type="text/css" href="http://rocsps/sites/GSTIntranet/QUALITY/PSR/SiteAssets/Warranty_Custom_Code/ListViewCustomizeFiles/jsLinkStyle.css">'
  );
...
function ShowDialogVersion(id) {
  var options = {
    ...
    showClose: true,
    url:
      "http://rocsps/sites/GSTIntranet/QUALITY/PSR/Lists/Warranty/DispForm.aspx?ID=" +
      id +
      "",
